...
function Blogs() {
    ...
    useEffect(()=> 
    {
        ...
        axios.get("https://peer-backend.vercel.app/api/blogs").then((res)=>
        {
    ...
    const handleLike = async (blog_id) => {
        try {
            ...
            const response = await axios.patch(`https://peer-backend.vercel.app/api/blogs/like/${blog_id}`);
    ...
    const handleNewBlogSubmit = (event) => {
        ...
        // axios.post("https://blog-project-starter-backend.vercel.app/api/blogs", { newTitle, date, newContent, likes }).then((res) => {
            axios.post("https://peer-backend.vercel.app/api/blogs", { newTitle, date, newContent, likes }).then((res) => {
            console.log(res.data)
